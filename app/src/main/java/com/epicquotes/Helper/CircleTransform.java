...
public class CircleTransform  {
    ...
    public static Bitmap fastblur(Bitmap sentBitmap, int radius,Context context) {
        ...
        if(sentBitmap!=null) {
            bitmap = sentBitmap.copy(Bitmap.Config.ARGB_8888, true);
             ...
             bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.eq);
        }
        if (radius < 1) {
            return (null);
        }
